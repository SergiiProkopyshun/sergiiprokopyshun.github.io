...
function drawUsers(){
    ...
    users.map( function(user, index){
          ...
          <tr>
					...
					<td>
						<button class="btn btn-danger" onclick="delUser(${index})">Видалити</button>
					</td>
				</tr>
          `
    } )
...
function showModal(id){
	...
	<a class="btn btn-sm btn-success" href="https://www.google.com.ua/maps/@${user.adress.get.lat},${user.adress.get.lan}z">Показати на карті</a>
